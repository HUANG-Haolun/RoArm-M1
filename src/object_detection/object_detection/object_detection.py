...
# sys.path.append('/home/mihawk/anaconda3/envs/foundationpose/lib/python3.9/site-packages')
            ...
            while True:
                ...
                if find_bool and not first_bool:
                    ...
                    if debug>=1:
                        ...
                        # q = quaternion_from_matrix(center_pose[:3,:3])
                        # msg.pose.orientation.x = q[0]
                        # msg.pose.orientation.y = q[1]
                        # msg.pose.orientation.z = q[2]
                        # msg.pose.orientation.w = q[3]
                        # #translation
                        # msg.pose.position.x = center_pose[0,3]
                        # msg.pose.position.y = center_pose[1,3]
                        # msg.pose.position.z = center_pose[2,3]
